...
// --- Fetch Student's Specific Library Data ---
// 1. Get their quick stats
...
// 2. Fetch their actual borrowing history
$my_books = [];
try {
    $query = "
...
$header_title = "My Reading Workspace";
...
<div class="glass rounded-[32px] border border-slate-200/50 dark:border-slate-800/50 p-8 mt-8 shadow-sm">
    <h2 class="text-xl font-bold text-slate-900 dark:text-white mb-6">My Book History</h2>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="4" class="p-12 text-center">
                            ...
                            <p class="text-sm text-slate-500 mt-1">Visit the library to check out your first book!</p>
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
